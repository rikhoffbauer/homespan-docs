...
* **HomeSpan now supports *Tag-Length-Value ("TLV8")* Characteristics!**
  ...
  * see the new [TLV8 Characteristics](TLV8.md) page for complete details and documentation 
...
* **Added support for customizing Pixel chips**
  ...
  * see the [Adressable RGB LEDs](Pixels.md) page for details
...
* [HomeSpan Stepper Motor Control](Stepper.md) - integrated control of stepper motors, including PWM microstepping
...
* [HomeSpan TLV8 Characteristics](TLV8.md) - classes and methods for creating TLV8 objects to use with TLV8-based Characteristics
* [HomeSpan Device Cloning](Cloning.md) - seamlessly swap a broken device for a new one without needing to re-pair and lose HomeKit automations
